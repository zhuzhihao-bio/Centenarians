...
df<-read.table("./data_fig1/upset/eggnogAnno01.tsv",header=T)
df<-df[,-1]
...
res <- cor.test(Dat$Age, Dat$Annotation_rate)
p_value <- round(res$p.value,30)
cor_value <- round(res$estimate, 3)
